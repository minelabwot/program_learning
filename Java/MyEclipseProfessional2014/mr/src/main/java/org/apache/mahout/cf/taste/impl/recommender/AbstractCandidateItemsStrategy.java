 ...
 */
//AbstractCandidateItemsStrategy调用了CandidateItemsStrategy接口
public abstract class AbstractCandidateItemsStrategy implements CandidateItemsStrategy,
  ...
  @Override
  /**
   * 实际上调用的是AbstractCandidateItemsStrategy的getCandidateItems方法
   * userID->userID
   * preferenceFromUser->GenericUserPreferenceArray
  ...
  public FastIDSet getCandidateItems(long userID, PreferenceArray preferencesFromUser, DataModel dataModel,
	  ...
	  /**
	   * preferenceFromUser->GenericUserPreferenceArray
	   * preferenceFromUser.getIDs()->ids[]->itemIDS->userID已知的itemIDs
	   * dataModel->GenericDataModel
	   * includeKnownItems->true
	   */
